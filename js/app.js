...
document.getElementById("HI").addEventListener('mouseover', printLyric);

function printLyric(){
  document.getElementById("lyric").innerHTML = "It's me";
}

};
/*7. Create your own event listener*/
function showFood(){
  document.getElementById("displayFood").innerHTML = "ICE CREAM";
}
